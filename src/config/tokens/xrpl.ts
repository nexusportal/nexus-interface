...
// export const XORACLE = new Token(ChainId.XRPL, '0xe8e01cbBE3f0ef723C9F13d260477335a4C0a948', 18, 'WXRPL', 'Wrapped XRPL EVM')
export const TOKENONE = new Token(ChainId.XRPL, '0x77926DA2d20D32f6F1F5f65621296290d589caA9', 18, 'ONE', 'Token One')
export const TOKENTWO = new Token(ChainId.XRPL, '0xEb7541D63C9d7E922E7f58A7bAA83c4C5fB91060', 18, 'TWO', 'Token Two')
export const TOKENTHREE = new Token(ChainId.XRPL, '0x2Ce736fCCD5924Ac434cFb58D812c8809d1f0109', 18, 'THREE', 'Token Three')
