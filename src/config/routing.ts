...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.APOTHEM]: [...WRAPPED_NATIVE_ONLY[ChainId.APOTHEM], APOTHEM_TOKENS.AIR, APOTHEM_TOKENS.EARTH, APOTHEM_TOKENS.FIRE, APOTHEM_TOKENS.SPACE, APOTHEM_TOKENS.WATER, APOTHEM_TOKENS.NEXUS],
