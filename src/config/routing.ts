...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.APOTHEM]: [...WRAPPED_NATIVE_ONLY[ChainId.APOTHEM], APOTHEM_TOKENS.AIR, APOTHEM_TOKENS.EARTH, APOTHEM_TOKENS.FIRE, APOTHEM_TOKENS.SPACE, APOTHEM_TOKENS.WATER, APOTHEM_TOKENS.NEXUS, APOTHEM_TOKENS.xBTC, APOTHEM_TOKENS.xETH, APOTHEM_TOKENS.xUSDC, APOTHEM_TOKENS.xUSDC, APOTHEM_TOKENS.xUSDT, APOTHEM_TOKENS.WAN],
  [ChainId.XDC]: [...WRAPPED_NATIVE_ONLY[ChainId.XDC], XDC_TOKENS.NEXUS],
}
