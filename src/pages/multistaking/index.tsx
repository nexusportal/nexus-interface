...
function ProStaking() {
  ...
  return (
    <Container id="prostaking-page" className="py-4 md:py-8 lg:py-12" maxWidth="5xl">
      <Head>
        <title key="title">NEXUS Swap | ProStaking</title>
          ...
          <div className="flex flex-wrap top-area">
            <div className="w-full md:w-[calc(100%-300px)] md:pr-4">
              ...
              <div className="mb-4 text-sm font-normal content md:text-base">
                <p>
                  This is where The NEXU unite.
                  <br /> Stake NEXU, THE NEXUS NFTs, & Nexus to harvest the rewards generated by the NEXU Factory,
                  NEXU Distributor, Prophet Sacrifice & more.
                  <br /> This staking system distributes a variety of tokens and token pairs. Some tokens are NEXU,
                  Nexus, NEXUS NLPs and more. Main examples of NLPs are NEXU pairs like NEXU/XRP, NEXU/NEXUS. NLPs from
                  future pairs with NEXU will be distributed here.
                </p>
                <a
                  href="https://docs.oracleswap.io/guides/multistaking-pro-the-oracles-nfts"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <div className="p-5 mt-3 mb-1 text-sm font-bold bg-red-500 rounded-md warning md:text-base">
                <p>
                  Warning: 1% of your NEXU will be burnt when you STAKE/UNSTAKE. Be mindful of this when staking. If you
                  break your timelocks you will lose 50% of your NEXU/Nexus stake. It is not recommended to lock up all
                  of your holdings. Use at your own risk.
                </p>
              </div>
            </div>
            ...
            <div className="w-full md:w-[300px] mt-2 md:mt-0">
                  ...
                  <div className="flex flex-col flex-wrap">
                    ...
                    <div className="flex flex-row mb-3">
                      ...
                      <QuestionHelper
                        ...
                        text={`BE AWARE OF GAS SPENDING WHEN CALLING THE DIST/BURN! The OracleDistributor receives DEX swap fees from the feeToo address of the OracleSwapFactory Contract. The fees are in the form of NLP Tokens. NEXUS Token holders can publicly call the Distribute function to convert the NLP Tokens to NEXUS and distribute them. 70% of the NEXUS is sent to the OracleFoundry/Stakers, 10% is sent to the treasury, 10% is sent to Prophet Sacrifice, and 10% is sent to the dead address. If the OracleTreasury address is zero then the 10% is sent to Prophet Sarifice.`}
                      />
                    </div>
                    ...
                    <div className="flex flex-col flex-grow text-base md:mb-3">
                      ...
                      <p>
                        <span>&#127789; </span> Nexus To Stakers: <span>{foundry?.toSignificant(6)}</span>
                        {/* &#127835; */}
                      </p>
                      <p>
                      ...
                      <p>
                        <span>&#128293;</span> Nexus To Sacrifice: <span>{prophet?.toSignificant(6)}</span>
                      </p>
                      <p>
                        <span>&#127974;</span> Nexus To Treasury: <span>{treasury?.toSignificant(6)}</span>
                      </p>

                      {oracleBalance?.equalTo(ZERO) && (
                        <div className="mt-2 text-base text-red">{`Your nexus balance is zero, so you cannot dist/burn olp`}</div>
                      )}
              ...
              <div className="bg-dark-900 rounded-3xl p-5 md:mt-2">
                <div className="self-end text-lg font-bold md:text-2xl text-high-emphesis md:mb-1">
                  {i18n._(t`Parameters📜`)}
                </div>

                <p className="text-sm font-normal md:text-base">
                  -Stake just NEXU with or without a timelock. The timelock multiplies your NEXU Power giving you a larger
                  share of the pool.
                  <br />
                  -To add NEXU NFTs you must stake the minimum amount of NEXU one time and you must also stake the
                  minimum Nexus amount per NFT.
                  <br />
                  -Consequences for breaking the spacetime barrier: Forfeit 50% of your locked NEXU/Nexus. Half of this
                  NEXU/Nexus gets sent to the void. Half goes back to the Loyal Stakers.
                  <br />
                  -If you are not yet wise, it is recommended to experiment with the system using negligible amounts of
                  tokens before going all In.
                  <br />
