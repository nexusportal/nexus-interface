          ...
          <div className="flex flex-wrap top-area">
            <div className="w-full md:w-[calc(100%-300px)] md:pr-4">
              ...
              <div className="mb-4 text-sm font-normal content md:text-base">
                <p>
                  Stake NEXU, THE NEXUS NFTs, & Nexus to harvest the rewards generated by the NEXU Factory,
                  NEXU Diffuser.
                  This staking system distributes a variety of tokens and token pairs. Some tokens are NEXU,
                  Nexus NLPs and more. Main examples of NLPs are NEXU pairs like NEXU/WBTC, NEXU/USDT. NLPs from
                  future pairs with NEXU will be distributed here.
                </p>
                <a
                  href="https://docs.thenexusportal.io/"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <div className="mb-4 text-sm font-normal content md:text-base">
                  <p>
                    ...
                    <br />
                    -Consequences for breaking the spacetime barrier: Forfeit 50% of your locked NEXU. Half of this NEXU gets sent to the void. Half goes back to the Loyal Stakers.
                    <br />
