            ...
            <div className="w-full md:w-[calc(100%-300px)] md:pr-4">
              ...
              <div className="mb-4 text-sm font-normal content md:text-base">
                <p>
                  ...
                  <br /> Stake PRO, THE NEXUS NFTs, & xORACLE to harvest the rewards generated by the Oracle Factory,
                  ...
                  xORACLE, NEXUS OLPs and more. Main examples of OLPs are PRO pairs like PRO/XRP, PRO/NEXUS. OLPs from
              ...
              <div className="p-5 mt-3 mb-1 text-sm font-bold bg-red-500 rounded-md warning md:text-base">
                <p>
                  ...
                  break your timelocks you will lose 50% of your PRO/XORACLE stake. It is not recommended to lock up all
            ...
            <div className="w-full md:w-[300px] mt-2 md:mt-0">
              ...
              <div className="bg-dark-900 rounded-3xl p-5 md:mt-2">
                ...
                <p className="text-sm font-normal md:text-base">
                  ...
                  share of the pool.
                  <br />
                  -To add Oracle NFTs you must stake the minimum amount of PRO one time and you must also stake the
                  minimum xORACLE amount per NFT.
                  <br />
