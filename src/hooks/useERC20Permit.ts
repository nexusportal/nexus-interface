...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [SUSHI[1].address]: { type: PermitType.AMOUNT, name: 'NEXUSSwap' },
  },
  [4]: {
    ...
    // @ts-ignore TYPE NEEDS FIXING
    [SUSHI[4].address]: { type: PermitType.AMOUNT, name: 'NEXUSSwap' },
  },
  [3]: {
    // @ts-ignore TYPE NEEDS FIXING
    [SUSHI[3].address]: { type: PermitType.AMOUNT, name: 'NEXUSSwap' },
  ...
  [5]: {
    // @ts-ignore TYPE NEEDS FIXING
    [SUSHI[5].address]: { type: PermitType.AMOUNT, name: 'NEXUSSwap' },
  },
  [42]: {
    // @ts-ignore TYPE NEEDS FIXING
    [SUSHI[42].address]: { type: PermitType.AMOUNT, name: 'NEXUSSwap' },
  },
}
