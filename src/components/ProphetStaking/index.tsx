          ...
          <div className="flex flex-col justify-between flex-1 px-4 py-4 rewards bg-dark-900 rounded-3xl">
            ...
            <div className="flex flex-row mb-3">
              ...
              <QuestionHelper
                ...
                text={`You may notice some tokens called OLP. Each OLP is different and represents a pair. For example: PRO/WXRP, PRO/ORACLE & PRO/xORACLE. Go to Pool > Browse to visualize it.`}
              />
            </div>
